...
)
{
    ...
    )
    {
        ...
        IConfirmationVisitor visitor =
            new ConfirmationVisitor(emailSender, textSender, "You have an appointment!", patient);
    ...
    private void CheckReservableAsset(Appointment newAppointment, Patient patient)
    {
        if (newAppointment.ReservableAsset != null)
        {
            ...
            foreach (var p in patients)
            {
                ...
                if (items.Any(i =>
                        newAppointment.ReservableAsset
                            .Equals(i.ReservableAsset))) // Machine is taken in this timeslot already!
